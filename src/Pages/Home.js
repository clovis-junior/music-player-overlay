...
function YouTubeMusic() {
    ...
    return (
        <main className='panel'>
            <figure>
                <AsyncImage className='platform-logo' src={ytmLogo} alt={'YouTube Music Logo'} />
            </figure>
...
function Spotify() {
        ...
        useLayoutEffect(()=>{
            if(!response) {
                async function GetAccess() {
                    setResponse(await GetAccessToken(params.get('code')));
                }
    ...
    return (
        <main className='panel'>
            <figure>
                <AsyncImage className='platform-logo' src={spotifyLogo} alt={'Spotify Logo'} />
            </figure>
